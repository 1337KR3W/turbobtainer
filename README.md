...
[![Version](https://img.shields.io/badge/Version-1.3.1-blue?style=flat-square&logo=githubactions)](https://github.com/1337KR3W/turbobtainer/releases)
...
# Content
  ...
  - [Key Features v1.3.1](#Key-Features-v131)
...
| File | Description |
| :--- | :--- |
| [`turbobtainer_1.3.1_x64.msi`](https://github.com/1337KR3W/turbobtainer/releases/download/v1.3.1/turbobtainer_1.3.1_x64_en-US.msi) | Windows Managed Installer (64-bit). Includes automated resource mapping and system integration. |
...
* **Playlist Extraction:**
* **ASCII Backgrounds:** More ASCII art :)
* **Improved Real-time Progress:** Live progress tracking for both single files and multi-item galleries.
